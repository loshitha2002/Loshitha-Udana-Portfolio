...
// Add loading screen CSS if not exists
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const elements = document.querySelectorAll('.about-card, .project-card, .skill-item, .contact-card');
    elements.forEach((element, index) => {
        element.style.animationDelay = `${index * 0.1}s`;
    });
});

// Background particles effect (optional enhancement)
